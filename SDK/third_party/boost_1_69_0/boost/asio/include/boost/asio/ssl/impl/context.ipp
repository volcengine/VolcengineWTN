  ...
  : handle_(0)
{
  ...
  case context::tlsv13_server:
    ...
    break;
      ...
      // TLS v1.3 compatible, added by wrb
#if (OPENSSL_VERSION_NUMBER >= 0x1010007fL) \
    && !defined(LIBRESSL_VERSION_NUMBER)
  case context::tlsv13_compatible:
      handle_ = ::SSL_CTX_new(::TLS_method());
      if (handle_)
      {
          SSL_CTX_set_min_proto_version(handle_, TLS1_VERSION);
      ...
      break;
  case context::tlsv13_compatible_client:
      handle_ = ::SSL_CTX_new(::TLS_client_method());
      if (handle_)
      {
          SSL_CTX_set_min_proto_version(handle_, TLS1_VERSION);
      ...
      break;
  case context::tlsv13_compatible_server:
      handle_ = ::SSL_CTX_new(::TLS_server_method());
      if (handle_)
      {
          SSL_CTX_set_min_proto_version(handle_, TLS1_VERSION);
      ...
      break;
#else // (OPENSSL_VERSION_NUMBER >= 0x1010007fL)
      //   && !defined(LIBRESSL_VERSION_NUMBER)
  case context::tlsv13_compatible:
  case context::tlsv13_compatible_client:
  case context::tlsv13_compatible_server:
      boost::asio::detail::throw_error(
          boost::asio::error::invalid_argument, "context");
      break;
#endif // (OPENSSL_VERSION_NUMBER >= 0x1010007fL)
      //   && !defined(LIBRESSL_VERSION_NUMBER)
